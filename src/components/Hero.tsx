...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center pt-24 pb-12 px-6 relative">
      {/* Background Image */}
      <div 
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        {/* Subheadline */}
        <p className="text-base md:text-xl text-white mb-8 max-w-2xl mx-auto leading-relaxed px-4">
        ...
        <div className="mb-8">
          <button 
            ...
            className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 opacity-100"
          >
